...
public class MainAgenda {
	...
	private static void cadastraContato(Agenda agenda, Scanner scanner) {
		try {
			...
			System.err.println("CONTATO INVALIDO");
		}
	}
	
	/**
	 * Interface para adicionar um contato como favorito
	 * @param agenda objeto agenda
	 * @param scanner scanner para receber os dados
	 */
	...
	/**
	 * Interface para remover um contato favorito da classe Agenda
	 * @param agenda objeto agenda
	 * @param scanner scanner para receber os dados
	 */
	public static void removeFavorito(Agenda agenda, Scanner scanner) {
		...
		agenda.removeFavoritos(posicao);
	}
	
	/**
	 * Chama o método da classe agenda e retorna todos os contatos favoritos cadastrados
	 * @param agenda objeto agenda
	 */
